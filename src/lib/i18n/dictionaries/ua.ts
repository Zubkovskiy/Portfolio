...
export const ua: Dictionary = {
  meta: {
    ...
    description:
      'Фронтенд-розробник і спеціаліст з автоматизації на основі ШІ з Бровар. Створюю швидкі, чисті інтерфейси на React, Next.js і TypeScript та практичні автоматизації.',
    ogDescription:
      'Фронтенд-розробник і спеціаліст з ШІ-автоматизації з Бровар. React · Next.js · TypeScript · автоматизація.',
    keywords: [
      'фронтенд розробник',
      'React розробник',
      'Next.js',
  ...
  hero: {
    ...
    roles: ['Фронтенд-розробник', 'Спеціаліст з ШІ та автоматизації', 'Майбутній Full-Stack розробник'],
    bio: 'Створюю швидкі, доступні інтерфейси на React, TypeScript і Next.js та практичні автоматизації на основі ШІ. П’ять проєктів уже онлайн — зараз пишу фронтенд у «Лізі Юнайтед» і зростаю до full-stack.',
    ctaPrimary: 'Переглянути проєкти',
    ctaDownload: 'Завантажити CV',
    ctaDownloadShort: 'CV',
    stats: [
      { value: '5', label: 'проєктів онлайн' },
  ...
  about: {
    ...
    title: 'Хто такий',
    highlight: 'Богдан',
    bio: 'Фронтенд-розробник, який створює інтерактивні інтерфейси, готові до продакшену. Мій шлях почався з ручної верстки HTML і CSS, продовжився JavaScript та React, а зараз — це TypeScript, Next.js і робочі процеси з ШІ. Наразі пишу фронтенд у «Лізі Юнайтед», а в публічному доступі маю п’ять проєктів: від лендингів, зверстаних точно за макетом, до повноцінного інтернет-магазину з клієнтським роутингом, глобальним станом і збереженим кошиком. Мені важливо не лише те, що інтерфейс працює, а і як він написаний: семантична верстка, передбачуваний стан і відчуття від роботи з ним.',
    goalTitle: "Кар'єрна мета",
    goal: 'Найкраще працюю в команді, де діляться знаннями й дають чесний зворотний зв’язок. Зараз поглиблюю бекенд — Node.js, API та роботу з даними, — щоб доводити задачу до кінця, а не зупинятися там, де закінчується фронтенд. Шукаю фронтенд- або full-stack позицію, у якій вестиму функціонал від ідеї до релізу, вчитимусь у сильніших інженерів і поступово братиму ширшу зону відповідальності.',
    profileCard: {
  ...
  projects: {
    ...
    title: 'Мої',
    highlight: 'проєкти',
    note: 'Кожен проєкт нижче — робочий. Відкрийте будь-який і спробуйте в дії.',
    items: [
      {
        title: 'Nice Gadgets',
      ...
      },
      {
        ...
        description:
          'Точна до пікселя посадкова сторінка за макетом. Гнучка сітка від 320px до десктопу, бургер-меню на всю ширину та форма зворотного зв’язку з валідацією — семантична верстка вручну, без фреймворків.',
        linkLabel: 'Відкрити демо',
  ...
  contact: {
    ...
    labels: {
      ...
      statusShort: 'Відкритий до пропозицій',
    },
    info: {
      address: 'Бровари, Україна',
      availability: 'Відкритий до фрілансу та віддаленої роботи',
    },
  },

  footer: {
    tagline: 'Фронтенд-розробник і спеціаліст з автоматизації на основі ШІ з Бровар, Україна.',
    navTitle: 'Навігація',
  ...
  cv: {
    ...
    objective:
      'Найкраще працюю в команді, де діляться знаннями й дають чесний зворотний зв’язок. Шукаю фронтенд- або full-stack позицію, у якій вестиму функціонал від ідеї до релізу, вчитимусь у сильніших інженерів і поступово братиму ширшу зону відповідальності — повна зайнятість, віддалено або фріланс.',
    statusLabels: {
      complete: 'завершено',
